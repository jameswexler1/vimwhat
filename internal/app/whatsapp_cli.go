...
type WhatsAppLiveSession interface {
	...
	ForwardMessage(context.Context, whatsapp.ForwardMessageRequest) (whatsapp.SendResult, error)
	...
	SetPresenceAvailable(context.Context, bool) error
	...
	SyncAppState(context.Context) ([]whatsapp.Event, error)
