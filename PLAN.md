...
- Fetch WhatsApp sticker app-state once after the live WhatsApp session connects, so favorite/recent stickers are populated into the transient cache without syncing on every picker open.
