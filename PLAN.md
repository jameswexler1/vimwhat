...
- Visible-first chat avatar sync and compact chat-list rendering, backed by WhatsApp profile-picture refreshes, cached local avatar files, overlay-safe inline avatar previews, and initials fallback when inline image rendering is unavailable.
